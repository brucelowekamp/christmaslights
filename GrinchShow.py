...
class GrinchShow(Show):
  ...
  def SetArgs(parser):
    ...
    parser.add_argument('--darktime', type=int, default=4, help="time to remain dark after slide before reset")
  ...
  def StartGrinch(self):
    ...
    self.LoadTimings( [
      ...
      (t+3, GrinchShow.GrinchCommands.START_SLIDE)
    ])

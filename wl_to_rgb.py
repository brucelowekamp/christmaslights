...
# from http://www.noah.org/wiki/Wavelength_to_RGB_in_Python, tagged as "free software"
'''
...
if __name__ == '__main__':
  try:
    ...
    parser.add_option('--png', action='store_true', default=True, help='Output as PNG.')
    parser.add_option('--ppm',
                      action='store_true',
                      default=False,
                      help='Output as PPM ASCII (Portable Pixmap).')
